...
function SubmitBill() {
  ...
  />
    ...
    /* OCR Button and Progress */
              ...
              {fileUrl && <div className="space-y-2">
                  <Button
    type="button"
    variant="outline"
    className="w-full"
  ...
  >
    ...
    /* OCR Progress */
                  ...
                  {isProcessingOCR && ocrProgress && <div className="space-y-1">
  ...
  />
    ...
    /* Risk Display */
            ...
            {showRiskScore && <div className="p-4 bg-gray-50 rounded-lg border">
