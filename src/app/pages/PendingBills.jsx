      ...
      <Card>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              {pendingBills.map((bill) => <TableRow key={bill.id} className={bill.riskLevel === "high" ? "bg-red-50" : ""}>
                  ...
                  <TableCell>
                    {bill.fraudAlerts.length > 0 ? <div className="flex items-center gap-1 text-red-600">
                        <AlertTriangle className="w-4 h-4" />
                        <span className="text-sm">{bill.fraudAlerts.length}</span>
                      </div> : <span className="text-gray-400 text-sm">None</span>}
                  </TableCell>
              ...
              {pendingBills.length === 0 && <TableRow>
