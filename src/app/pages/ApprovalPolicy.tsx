...
export default function ApprovalPolicy() {
  const [policies, setPolicies] = useState({
    ...
    travelLimitPerDay: 10000,
    repairMaxLimit: 50000,
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-700">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setPolicies({ ...policies, lowThreshold: parseInt(e.target.value) })
                  }
                  className="w-32"
                />
            ...
            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-700">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setPolicies({ ...policies, mediumThreshold: parseInt(e.target.value) })
                  }
                  className="w-32"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setPolicies({ ...policies, travelLimitPerDay: parseInt(e.target.value) })
                }
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setPolicies({ ...policies, repairMaxLimit: parseInt(e.target.value) })
                }
              />
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setPolicies({ ...policies, autoHighRiskThreshold: parseInt(e.target.value) })
              }
              className="max-w-xs"
            />
