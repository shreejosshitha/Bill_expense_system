...
function Layout() {
  ...
  return <div className="flex h-screen bg-gray-50">
    ...
    /* Sidebar */
      ...
      <aside
    className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transition-transform duration-300 lg:translate-x-0 lg:static`}
  >
    ...
    return <Link
      ...
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${isActive ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-100"}`}
    >
    ...
    /* Notifications */
              ...
              <Link to="/notifications">
                <Button variant="ghost" size="icon" className="relative">
                  ...
                  {unreadCount > 0 && <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 bg-red-500">
                      {unreadCount}
                    </Badge>}
                </Button>
              </Link>
